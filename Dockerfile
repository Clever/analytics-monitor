...
CMD ["/usr/bin/sfncli", "--cmd", "/usr/bin/analytics-monitor", "--activityname", "${_DEPLOY_ENV}--${_APP_NAME}", "--region", "us-west-2", "--cloudwatchregion", "us-west-1", "--workername", "MAGIC_ECS_TASK_ID"]
